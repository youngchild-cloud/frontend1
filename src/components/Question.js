...
function Question(props) {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://port-0-backend-express-server-mkvwe9x45fceba4b.sel3.cloudtype.app/api/question', formData)
  ...
  const loadData = () => {
    //비동기 통신 사용
    axios
      .get('https://port-0-backend-express-server-mkvwe9x45fceba4b.sel3.cloudtype.app/question')
      //성공시 데이터를 저장
      .then(res => {
        setData(res.data);
