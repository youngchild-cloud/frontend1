...
function GoodsUpdate(props) {
  ...
  useEffect(() => {
    axios.get(`https://port-0-backend-express-server-mkvwe9x45fceba4b.sel3.cloudtype.app/goods/${g_code}`)
      //성공이면 출력
      .then(res => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.put(`https://port-0-backend-express-server-mkvwe9x45fceba4b.sel3.cloudtype.app/goods/goodsupdate/${g_code}`, {
